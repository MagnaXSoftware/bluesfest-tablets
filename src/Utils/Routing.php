...
class Routing
{
    public static function routeToCallable(Route $route): callable
    {
     ...
     */
    public static function routeAttributes(Route $route): array
    {
        $callable = self::routeToCallable($route);
        try {
